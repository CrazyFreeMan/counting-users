<!-- BEGIN: MAIN -->			
 			<table class="table table-striped">
				...
				<tr>
					...
					<td><span class="label label-info">{INDEX_COUNT_USR_4}</span></td>
				</tr>
				<!-- ENDIF -->
				<!-- IF {INDEX_COUNT_USR_7} -->
				<tr>
					<td>{PHP.L.fr_employers_title}</td>
					<td><span class="label label-info">{INDEX_COUNT_USR_7}</span></td>
				</tr>
				<!-- ENDIF -->
				<!-- IF {INDEX_COUNT_USR_8} -->
				<tr>
					<td>{PHP.L.fr_traders_title}</td>
					<td><span class="label label-info">{INDEX_COUNT_USR_8}</span></td>
				</tr>
				<!-- ENDIF -->
